...
if [ "$USE_REGISTRY" = true ]; then
  REGISTRY_IMAGE="127.0.0.1:5000/ns:latest"
  ...
  echo "ℹ️  Update deployment.yaml image to: docker-registry.erp-infra.svc.cluster.local:5000/ns:latest"
else
