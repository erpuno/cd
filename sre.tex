...
\vspace{6pt}
{\footnotesize
\begin{longtable}{L{5.5cm} L{2.0cm} L{1.6cm} C{0.9cm} L{1.7cm} L{1.5cm}}
\toprule
\rowcolor{headerbg}
\color{primary}\textbf{Сервіс} & \color{primary}\textbf{Namespace} & \color{primary}\textbf{Kind} & \color{primary}\textbf{Port} & \color{primary}\textbf{CPU req/lim} & \color{primary}\textbf{Легенда} \\
\midrule\endhead\bottomrule\endfoot
\multicolumn{6}{l}{\textcolor{infrablue}{\bfseries\small erp-infra --- Рівень інфраструктури}}\\
\midrule
...
\midrule
\multicolumn{6}{l}{\textcolor{successgreen}{\bfseries\small erp-telemetry --- Рівень спостереження}}\\
\midrule
...
\midrule
\multicolumn{6}{l}{\textcolor{secpurple}{\bfseries\small erp-security --- Рівень безпеки}}\\
\midrule
\texttt{ca-pki}          & erp-security & Deployment & 8201 & 100m/500m & DSV \\
\midrule
\multicolumn{6}{l}{\textcolor{tieryellow}{\bfseries\small erp-ai --- Рівень AI моделей}}\\
\rowcolor{rowalt}\texttt{ai-generation} & erp-ai & Deployment & 8601 & 100m/500m & DSV \\
\midrule
\multicolumn{6}{l}{\textcolor{tieryellow}{\bfseries\small erp-services --- Рівень служб і сервісів}}\\
\midrule
...
\midrule
\multicolumn{6}{l}{\textcolor{tieryellow}{\bfseries\small erp-apps --- Рівень ІКС}}\\
\midrule
