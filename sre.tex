...
\texttt{otel-collector} & erp-telemetry & Deployment & 8404 & 100m/500m & deployment, service, values \\
\midrule
...
\rowcolor{rowalt}\texttt{otel/otel-collector} & \texttt{otel-collector} (OpenTelemetry шлюз) \\[2pt]
