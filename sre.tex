...
\subsection{Namespace-рівні та їхні відповідальності}
...
% ===========================================================================
\newpage
\section{Структура репозиторію \texttt{erpuno/cd}}
...
\texttt{shared/}         & Кластерні ресурси: \texttt{namespaces.yaml}, \texttt{rbac.yaml}, \texttt{networkpolicy.yaml}, \texttt{storage-class.yaml} \\[2pt]
...
% ===========================================================================
\newpage
\section{Helm-чарт та синхронізація з \texttt{lib/}}
...
\subsection{NetworkPolicy --- модель «deny-by-default»}

Двошаровий підхід у \texttt{shared/networkpolicy.yaml}:
...
% ===========================================================================
\newpage
\section{Observability Stack (erp-telemetry)}
...
\midrule\endhead\bottomrule\endfoot
1/8 & Namespaces + RBAC & \texttt{kubectl apply} на \texttt{shared/namespaces.yaml}, \texttt{rbac.yaml}, \texttt{storage-class.yaml}, \texttt{networkpolicy.yaml} \\[2pt]
