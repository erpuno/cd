...
\begin{abstract}
\noindent
Цей \textbf{CD/SRE Handbook} є авторитетним технічним довідником з Site Reliability Engineering
...
\texttt{images.sh} & bash-скрипт відображення Docker контейнерів з ERP/1 службами і ІКС\\[2pt]
\texttt{kind.sh} & bash-скрипт управління K8S контекстами Kind\\[2pt]
\texttt{liveness.sh} & bash-скрипт статусу ArgoCD простору\\[2pt]
\texttt{manifest.rb} & bash-скрипт, який використовується \texttt{backup.sh} для фільтрації K8S маніфестів\\[2pt]
...
\texttt{values.rb} & Ruby-скрипт: читає \texttt{lib/} $\rightarrow$ генерує \texttt{helm/values.yaml} \\[2pt]
...
\midrule\endhead\bottomrule\endfoot
\multicolumn{6}{l}{\textcolor{infrablue}{\bfseries\small Рівень інфраструктури}}\\
\midrule
...
\midrule
\multicolumn{6}{l}{\textcolor{successgreen}{\bfseries\small Рівень спостереження}}\\
\midrule
...
\midrule
\multicolumn{6}{l}{\textcolor{secpurple}{\bfseries\small Рівень безпеки}}\\
\midrule
\texttt{ca-pki}          & erp-security & Deployment & 8201 & 100m/500m & DSV \\
\midrule
\multicolumn{6}{l}{\textcolor{tieryellow}{\bfseries\small Рівень моделей}}\\
\rowcolor{rowalt}\texttt{ai-generation} & erp-ai & Deployment & 8601 & 100m/500m & DSV \\
\midrule
\multicolumn{6}{l}{\textcolor{tieryellow}{\bfseries\small Рівень служб і сервісів}}\\
\midrule
...
\midrule
\multicolumn{6}{l}{\textcolor{tieryellow}{\bfseries\small Рівень ІКС}}\\
\midrule
